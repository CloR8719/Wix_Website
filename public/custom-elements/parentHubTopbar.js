...
class ParentHubTopbar extends HTMLElement {
    constructor() {
        super();
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        ...
        try {
            ...
            console.error("parent-hub-topbar: couldn't parse data attribute", err);
        }
    }
...
if (!customElements.get("parent-hub-topbar")) {
    customElements.define("parent-hub-topbar", ParentHubTopbar);
}
...
//        title: "Home", sub: "Signol Athletic · Parent Hub", showBack: false
//    }));
//
